...
Portezuelo no comparten código. Acá se usa para importar las resoluciones del sistema anterior.
...
Lee en streaming: los DBF de despacho son chicos, pero el lector es el mismo.
