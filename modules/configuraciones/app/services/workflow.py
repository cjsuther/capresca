...
workflow. La regla por defecto es un nivel `APROBAR` con cuatro-ojos, INACTIVA: con un único
administrador el sistema opera sin bloquearse, y se activa cuando la organización suma un segundo
aprobador (H-141 de Créditos).
"""
...
def sembrar_reglas(db: Session) -> int:
    ...
    for modulo, objetos in CATALOGO.items():
        for objeto, nombre, descripcion in objetos:
