 ...
 */
export function VisorDocumento({ docs, inicial = 0, cargar, etiquetas = {}, onClose }) {
  ...
  return (
    <Modal titulo={etiquetas[doc.tipo] || doc.tipo} eyebrow="Documentación del solicitante" onClose={onClose} ancho="max-w-5xl"
           footer={<>
