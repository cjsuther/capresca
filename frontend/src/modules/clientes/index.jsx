...
import { Users, UserPlus, Building2, Upload } from "lucide-react";
...
export const clientesMenu = [
  ...
  { label: "Importar padrón", path: "/modules/clientes/padron", permission: "padron:importar", icon: Upload },
];
  ...
  return (
    <Layout sidebar={sidebar}>
      <Routes>
        ...
        <Route path="padron" element={<ImportarPadronPage />} />
